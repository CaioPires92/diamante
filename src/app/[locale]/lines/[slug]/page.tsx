...
export default async function LinePage({ params }: { params: Promise<{ locale: string; slug: string }> }) {
  ...
  const lineDescriptions: Record<string, string> = {
    ...
    'ox-profissional': 'Emulsões oxidantes profissionais para preparação de colorações e descolorações, disponíveis nas volumagens adequadas para cada técnica.',
    ...
    'nutritivo': 'Shampoo e condicionador nutritivos em embalagens profissionais de 5 litros para alto rendimento no salão.',
